...
def create_ml_pipeline(df, target_column):
    ...
    # Conversion de la cible en catégorielle si nécessaire
    if y.dtype in ['float64', 'int64'] and not all(y.astype(int) == y):
        ...
        y = pd.qcut(y, q=2, labels=False)  # Classification binaire
    ...
    # Configuration des hyperparamètres selon l'algorithme choisi
